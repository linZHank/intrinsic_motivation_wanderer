...
load_dir = os.path.join(sys.path[0], 'model_dir', seed, '2021-01-20-15-49')
...
# Load data
data_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2021-01-20-16-06/'
...
# Plot episode return
prevdata_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2021-01-20-15-49/'
