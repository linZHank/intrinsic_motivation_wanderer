...
# Load agent
load_dir = os.path.join(sys.path[0], 'model_dir', version, '2021-04-14-15-16')
...
# Load data
data_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/macromphalus_experience/2021-04-14-15-22'
...
# Plot episode return
data_dir0 = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/macromphalus_experience/2021-04-14-14-51'
