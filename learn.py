...
dim_act = 1
num_act = 10
data_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2020-11-25-16-19/'
# Instantiate agent
...
# Train policy
num_iters = 1
loss_pi, loss_v, loss_info = agent.train(replay_data, num_iters)
