...
load_dir = os.path.join(sys.path[0], 'model_dir', seed, '2021-01-15-10-50')
...
# Load data
data_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2021-01-15-11-12/'
...
# Plot episode return
prevdata_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2021-01-15-11-12/'
if not prevdata_dir==data_dir:
    prev_eprets = np.load(os.path.join(prevdata_dir, 'combined_episode_returns.npy'))
