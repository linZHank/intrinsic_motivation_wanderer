...
load_dir = os.path.join(sys.path[0], 'model_dir', seed, '2021-01-15-11-12')
...
# Load data
data_dir = '/media/palebluedotian0/Micron1100_2T/playground/intrinsic_motivation_wanderer/experience/2021-01-15-12-02/'
